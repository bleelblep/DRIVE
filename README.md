...
├── build-search-db.html                # Database builder
├── provider-config.js                  # Google Drive API configuration
├── provider-adapter.js                 # Google Drive API adapter
...
The website dynamically fetches content from Google Drive using the Google Drive API.

Each collection page (Music, Videos, Photos, etc.) queries the Google Drive API and renders files with appropriate previews and download links.
