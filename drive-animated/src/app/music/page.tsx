  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="p-8 md:p-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl mb-4 bg-gradient-to-r from-archive-violet to-archive-pink bg-clip-text text-transparent">
            MUSIC
          </h1>
          <p className="text-xs opacity-50">
            DEMOS, COLLABORATIONS, INSTRUMENTALS, UNRELEASED TRACKS
          </p>
        </motion.div>
      </div>
