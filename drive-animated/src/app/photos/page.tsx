  ...
  return (
    <main className="min-h-screen">
      <div className="p-8 md:p-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl mb-4 bg-gradient-to-r from-archive-pink to-archive-violet bg-clip-text text-transparent">
            PHOTOS
          </h1>
          <p className="text-xs opacity-50">
            PRESS PHOTOS, PERFORMANCE SHOTS, ARCHIVAL PHOTOGRAPHY
          </p>
        </motion.div>
      </div>
